...
import { calculateShippingFee, getAddress, selectAddress } from "../../app/action/addressAction";
                ...
                <Row>
                    ...
                    <Col sm={10}>
                        <Card>
                            ...
                            <Card.Body>
                                <h4>Pilih Alamat Pengiriman</h4><br />
                                    <Table >
                                        <thead>
                                            <tr>
                                ...
                                <Link 
                                    ...
                                    to={`/confirm`}>
                                        <Button variant="dark" onClick={() => handleSelectedAddress(selectedAddress)}>Next</Button>
                                </Link>
                            </Card.Body>
                        </Card>
                    </Col>
