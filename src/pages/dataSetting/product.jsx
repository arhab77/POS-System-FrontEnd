...
const DataProduct = () => {
    ...
    const handleUpdate = async (updateProduct) => {
        ...
        try {
            await axiosDriver.put(`http://localhost:3001/api/Product/${updateProduct._id}`, formData, {
                headers: {
    ...
    const handleAddProduct = async(ProductName, ProductImage, ProductDescription, ProductCategory, ProductTag, ProductPrice) => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:3001/api/Product?skip=${skip}&limit=${perPage}`).then((res) => {
        ...
        <div>
            <Container fluid>
                <Row>
                    ...
                    <Col>
                        <Navbars/><br />
                        <h2>Product Data</h2><br />
                        <div style={{textAlign:'right'}}>
                            <Button style={{marginBottom:'10px'}} onClick={handleShowModal}>Add Data Product</Button>
                        </div>
                                    ...
                                    data.map((item, id) => (
                                        <tr key={id}>
                                            ...
                                            <td className="text-center">
                                                <Button variant="warning" onClick={() => handleEditClick(item)}><FaEdit/></Button>
                                                {' '}
                                                <Button 
                                                    variant="danger" 
