...
export const addToCart = (product) => async (dispatch, getState) => {
    try {
        ...
        const response = await axiosDriver.put('http://localhost:3001/api/cart', { items: cartItems });
...
export const getCart = () => async (dispatch) => {
    try {
        const response = await axiosDriver.get('http://localhost:3001/api/cart');
...
// export const subTotal = (totalCost) => {
//     return {
//         type: 'SET_SUB_TOTAL',
//         payload: totalCost
//     };
...
export const incQuantity = (productId) => async(dispatch, getState) => {
    try {
        ...
        const response = await axiosDriver.put('http://localhost:3001/api/cart', { items: updateCart });
